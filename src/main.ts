...
answer1Btn.addEventListener('click', borderChange);
answer2Btn.addEventListener('click', checkAnswer);
answer2Btn.addEventListener('click', borderChange1);
answer3Btn.addEventListener('click', checkAnswer);
answer3Btn.addEventListener('click', borderChange2);

next.addEventListener('click', nextQuestion);

function borderChange() {
  answer1Btn.classList.toggle('open');
}

function borderChange1() {
  answer2Btn.classList.toggle('open');

}

function borderChange2() {
  answer3Btn.classList.toggle('open');
